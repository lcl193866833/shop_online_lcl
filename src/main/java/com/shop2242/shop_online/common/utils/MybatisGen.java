...
public class MybatisGen {
    ...
    public static void main(String[] args) {
        String path = System.getProperty("user.dir")
                ...
                .concat(File.separator).concat("shop2242")
                .concat(File.separator).concat("shop_online")
        ...
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/work_shop", "root", "lcl193866833")
                .globalConfig(builder -> {
                    builder.author("Ch35tnut").enableSwagger(); // 设置作者// 开启 swagger 模式

                })
                .packageConfig(builder -> {
                    builder.parent("com.shop2242") // 设置父包名
