...
import com.shop2242.shop_online.common.utils.AliyunResource;
import com.shop2242.shop_online.common.utils.FileResource;
import com.shop2242.shop_online.common.utils.GeneratorCodeUtils;
import com.shop2242.shop_online.convert.UserConvert;
...
import static com.shop2242.shop_online.constant.APIConstant.*;
...
//4、生成token,存入redis并设置过期时间
        ...
        String token = com.shop2242.shop_online.common.utils.JWTUtils.generateToken(JWT_SECRET,tokenVO.toMap());
